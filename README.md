...
<!-- renovate: datasource=github-releases depName=cisagov/cyhy-core -->
| cyhy\_core\_version | The version of cisagov/cyhy-core to install; must be a valid git reference. | `v1.3.3` | No |
